...
description: Expert system for creating Antigravity agent skills. Use when the user asks to create, generate, or build a new skill, or mentions skill development, skill templates, or .agent/skills directories.
---
...
- User asks to create, generate, or build a new skill
- User mentions skill development or skill templates
- User wants to extend agent capabilities with custom skills
- User references `.agent/skills/` directories
...
- **Project-specific skills**: Place in `<project-root>/.agent/skills/`
- **Global skills**: Place in `C:/Users/<username>/.agent/skills/` (Windows) or `~/.agent/skills/` (macOS/Linux)
