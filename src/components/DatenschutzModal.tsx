        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-12 text-[#2c1810] font-sans">
              <h1 className="text-3xl font-medieval mb-6 border-b-2 border-[#2c1810]/20 pb-4">
                Datenschutzerklärung
              </h1>

              <div className="space-y-6 text-sm md:text-base leading-relaxed datenschutz-content">
                <section>
                  <h2 className="text-2xl font-medieval text-[#8b4513] mb-4 mt-8">
                    1. Datenschutz auf einen Blick
                  </h2>

                  <h3 className="font-bold text-lg mb-2 text-[#8b4513]">
                    Allgemeine Hinweise
                  </h3>
                  <p>
                ...
                <section>
                  <h2 className="text-2xl font-medieval text-[#8b4513] mb-4">
                    2. Hosting
                  </h2>
                  <p>
                  ...
                  <p>
                    ...
                    unseren Weisungen und unter Einhaltung der DSGVO
                    verarbeitet.
                  </p>

                  <h3 className="font-bold text-lg mb-2 text-[#8b4513] mt-6">
                    Domain-Registrierung und DNS (netcup)
                  </h3>
                  <p>
                    Der Provider für unsere Domain und DNS-Dienste ist die
                    netcup GmbH, Daimlerstraße 25, 76185 Karlsruhe (nachfolgend
                    „netcup“).
                  </p>
                  <p className="mt-2">
                    Wenn Sie unsere Website besuchen, werden durch das
                    DNS-System Anfragen an die Nameserver von netcup gesendet.
                    Hierbei können personenbezogene Daten (z. B. IP-Adresse)
                    verarbeitet werden. Die Nutzung von netcup erfolgt im
                    Interesse einer sicheren und professionellen Verwaltung
                    unserer Domain. Dies stellt ein berechtigtes Interesse im
                  ...
                  <p>
                    Wir nutzen für die Speicherung Ihrer Daten und für die
                    Verwaltung der Logins den Dienst Supabase. Anbieter ist die
                    Supabase Inc., 970 Toa Payoh North #07-04, Singapur 318992
                    (bzw. US-Niederlassungen).
                  </p>

                  <h4 className="font-bold mt-4">Verarbeitung in der EU</h4>
                  <p>
                    Wir haben Supabase so konfiguriert, dass Ihre Daten (E-Mail,
                    Nickname, Reservierungen) ausschließlich auf Servern
                    innerhalb der Europäischen Union (Region: Irland/EU-West)
                    gespeichert werden.
                  </p>

                  <h4 className="font-bold mt-4">
                    Rechtsgrundlage und Sicherheit
                  </h4>
                  <p>
                    Die Nutzung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
                    DSGVO (technisch fehlerfreier und sicherer Betrieb unserer
                    Dienste) sowie Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung
                    zur Bereitstellung Ihres Nutzerkontos). Wir haben mit dem
                    Anbieter einen Vertrag über Auftragsverarbeitung (AVV)
                    geschlossen, der die Sicherheit Ihrer Daten gewährleistet.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="uppercase text-xs font-bold bg-[#2c1810]/5 p-2 rounded">
                  ...
                  <p className="uppercase text-xs font-bold bg-[#2c1810]/5 p-2 rounded mt-2">
                ...
                <section>
                  ...
                  <p>
                    ...
                    zusätzliche Funktionen zu nutzen. Die dazu eingegebenen
                    Daten verwenden wir nur zum Zwecke der Nutzung des
                  ...
                  <p className="mt-2">
                    ...
                    Daten erfolgt zum Zwecke der Durchführung des durch die
                    Registrierung begründeten Nutzungsverhältnisses und ggf. zur
                  ...
                  <p className="mt-2">
                    ...
                    sind und werden anschließend gelöscht. Gesetzliche
                  ...
                  <p>
                    ...
                    vorvertraglicher Maßnahmen gestattet. Personenbezogene Daten
                ...
                <section>
                  ...
                  <p className="mt-2">
                    ...
                    diese Website aufgerufen wurde. Die Nutzung von Google Fonts
                    erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
                    Websitebetreiber hat ein berechtigtes Interesse an der
                    einheitlichen Darstellung des Schriftbildes auf seiner
